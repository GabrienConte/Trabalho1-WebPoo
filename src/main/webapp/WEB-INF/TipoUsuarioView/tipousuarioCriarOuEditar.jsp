...
<div>
    <main>
        <div class="container content is-fluid mt-5 mb-5">
            <section>
                <h1 class="title">Criar novo Tipo de usuário</h1>

                <div class="container">
                    <form method="post" action="tiposusuario">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input name="tipo" id="tipo" class="input" type="text" placeholder="Tipo" value="${tipo != null ? tipo : ''}" required>
                            </div>
                        </div>
